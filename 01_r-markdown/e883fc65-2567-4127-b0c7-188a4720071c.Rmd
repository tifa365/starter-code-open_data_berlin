...
- **Metadata_modified** `2025-01-30T13:32:28.708291`
...
df <- read.csv('https://luftdaten.berlin.de/pollution/chb?stationgroup=all&period=1m&timespan=all')

# Distribution 7
# Package_id               : e883fc65-2567-4127-b0c7-188a4720071c

df <- read.csv('https://luftdaten.berlin.de/pollution/cht?stationgroup=all&period=1m&timespan=all')
